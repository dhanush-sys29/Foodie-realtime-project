                ...
                <div className="flex items-center gap-4">
                  {user.role === 'customer' && (
                    <>
                      ...
                      <Link to="/explore" className="text-white hover:text-primary font-medium transition-colors">
                        Explore Food
                      </Link>
                      <Link 
                        to="/checkout" 
                  ...
                  {user.role === 'agent' && (
                    <Link to="/" className="text-primary hover:text-white font-black text-xs tracking-[0.2em] uppercase transition-all">
                      ⚡ Fleet Command
                    </Link>
                  )}
                </div>
